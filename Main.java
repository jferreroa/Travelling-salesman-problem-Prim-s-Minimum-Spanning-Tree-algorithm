...
public class Main {
    public static void main(String[] args) {
        ...
        Graph test1;
        test1 = new Graph(3);
        test1.insert(0,0, (double) 0);
        test1.insert(0,1, (double) 10);
        test1.insert(0,2, (double) 20);

        test1.insert(1,0, (double) 10);
        test1.insert(1,1, (double) 0);
        test1.insert(1,2, (double) 5);

        test1.insert(2,0, (double) 20);
        test1.insert(2,1, (double) 5);
        test1.insert(2,2, (double) 0);


        System.out.print(test1.printSmallGraph("Graph 1"));

        Vector<Edge> travelTest1 = test1.tspPrim(test1, 0);
        for(Edge a : travelTest1){
            System.out.println((a.v + 1)+ " -> " +(a.w + 1) + " --" + " Cost [ " + (a.coste)+ " ]");
        }
        ...
        double[][] paths = {{0, 1118, 644, 535, 683, 995, 334, 609,1153,1010,340,738,473,763 ,947,676 ,961, 455, 411, 833},
                ...
                Graph tsp = new Graph(20,costs);
                System.out.print(tsp.printLargeGraph() + "\n");


                String[] cities={"A Coruna","Barcelona","Bilbao","Burgos","Caceres","Cordoba",
